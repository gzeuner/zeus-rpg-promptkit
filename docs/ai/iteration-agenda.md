...
The next planned item is Iteration 31: evidence-aware prompt adapters and local
review receipts. It may consume only this generic context contract and must keep
all source-derived material local-only.
