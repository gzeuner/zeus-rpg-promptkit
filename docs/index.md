...
| Process-answer regression gate      | [`ai/process-answer-regression.md`](ai/process-answer-regression.md)                                                                                                                                                               | Versioned process-answer checks with explicit reviewer decisions      |
