...
| ---------------- | ---------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------ |
| `ai/`            | AI contracts, session patterns, validation                                                                             | [`ai/agent-start-here.md`](ai/agent-start-here.md), [`ai/session-prompt.md`](ai/session-prompt.md)                                                                                                             | AI agents, prompt engineers                |
...
| AI first point to check             | [`ai/agent-start-here.md`](ai/agent-start-here.md)                                                                                                                                                                                 | Intent map, context contract, and live CLI/MCP orientation            |
