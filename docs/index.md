...
| ---------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------ |
| `ai/`            | AI contracts, CLI-first session patterns, process intelligence, glossary use, and validation                                                    | [`ai/agent-start-here.md`](ai/agent-start-here.md), [`ai/session-prompt.md`](ai/session-prompt.md), [`ai/process-intelligence.md`](ai/process-intelligence.md)                                                                                                                                 | AI agents, prompt engineers                |
...
| `quickstart/`    | Canonical evidence-investigation golden path plus credential, onboarding, and external read-only JDBC guides                                    | [`quickstart/5-minutes.md`](quickstart/5-minutes.md), [`quickstart/secrets-and-overrides.md`](quickstart/secrets-and-overrides.md), [`quickstart/onboarding-new-ibm-i.md`](quickstart/onboarding-new-ibm-i.md), [`quickstart/external-readonly-jdbc.md`](quickstart/external-readonly-jdbc.md) | All roles                                  |
...
| Business process questions          | [`ai/process-intelligence.md`](ai/process-intelligence.md), `process list`, `describe`, `query`, `impact`, `diff`                                                                                                                  | Evidence-backed process answers, glossary resolution, and freshness     |
...
| Process-answer regression gate      | [`ai/process-answer-regression.md`](ai/process-answer-regression.md), [`ai/process-answer-drift.md`](ai/process-answer-drift.md)                                                                                                   | Versioned checks, reviewer decisions, and bounded catalog-drift reports |
