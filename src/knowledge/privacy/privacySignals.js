...
const SIGNAL_DEFINITIONS = [
  ...
  },
  {
    ...
    test: (value) => /(\*\*FREE\b|\bDCL-(F|S|DS|PR|PI)\b|\bEXFMT\b|\bCHAIN\b|\bREADC\b|\bSFL(CLR|RRN|PAG|SIZ)\b|\bPGM\b|\bENDPGM\b|\bMONMSG\b|\bEXEC\s+SQL\b|\bSELECT\b.+\bFROM\b)/i.test(value),
  },
  {
  ...
  },
  {
    ...
    test: (value) => /\.zeus\/knowledge|\.local\/mcp\/audit|session-notes\/2026-05-22-pui-pattern-import/i.test(value),
  },
  {
