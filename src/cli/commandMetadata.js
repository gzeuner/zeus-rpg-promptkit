...
const COMMAND_UI_METADATA = Object.freeze([
  ...
  Object.freeze({
    ...
    advancedOptions: Object.freeze(['--show-resolved', '--config']),
    outputArtifacts: Object.freeze(['stdout table of checks']),
    recommendedNextCommands: Object.freeze(['fetch', 'query-table', 'analyze']),
  }),
  Object.freeze({
    name: 'fetch',
    title: 'Fetch Sources',
  ...
  Object.freeze({
    ...
    advancedOptions: Object.freeze(['--mode', '--extensions', '--optimize-context', '--test-data-limit', '--safe-sharing', '--config']),
  ...
  Object.freeze({
    ...
    commonOptions: Object.freeze(['--profile']),
    advancedOptions: Object.freeze(['--preset', '--out', '--continue-on-error', '--config']),
  ...
  Object.freeze({
    ...
    recommendedNextCommands: Object.freeze(['query-sql', 'analyze']),
  }),
  Object.freeze({
    name: 'query-sql',
    title: 'Query SQL',
