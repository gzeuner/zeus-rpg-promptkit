 ...
 *   zeus test-run start --profile dev --program APPPGM --table APPLIB.APP_TABLE_00 --key ID=88656 --label "CHANGE-1234 Test DAN=127002"
 *   # ... Test durchführen ...
...
async function run(args) {
  ...
  if (!subcommand || subcommand === 'help') {
    ...
    console.log('  zeus test-run start --profile dev --program APPPGM \\');
    console.log('       --table APPLIB.APP_TABLE_00 --key ID=88656 --label "Test DAN=127002"');
    console.log('  zeus test-run capture --profile dev --manifest test-run-manifest.json');
