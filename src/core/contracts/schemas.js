...
const INITIAL_SCHEMAS = Object.freeze({
  ...
  [CONTRACT_IDS.TECHNICAL_EVIDENCE_PROMPT]: {
    version: TECHNICAL_EVIDENCE_PROMPT_SCHEMA_VERSION,
    schema: value => validateTechnicalEvidencePrompt(value).map(message => ({ path: '', message })),
  },
  [CONTRACT_IDS.TECHNICAL_EVIDENCE_REVIEW]: {
  ...
  [CONTRACT_IDS.TECHNICAL_EVIDENCE_PROMPT_BUNDLE]: {
    version: TECHNICAL_EVIDENCE_BUNDLE_SCHEMA_VERSION,
    schema: value =>
      validateTechnicalEvidencePromptBundle(value).map(message => ({ path: '', message })),
  },
  [CONTRACT_IDS.TECHNICAL_EVIDENCE_HANDOFF_RECEIPT]: {
