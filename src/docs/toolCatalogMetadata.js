...
const COMMAND_METADATA = Object.freeze({
  ...
  'technical-evidence': Object.freeze({
    ...
    purpose:
      'Project already-anonymized technical evidence into a bounded source-neutral prompt, check prompt regressions, enforce a local-only egress gate, create fingerprint-only bundles and local handoff receipts, replay bundles for integrity verification, evaluate a final local acceptance matrix, and retain a bounded local acceptance history. The boundary rejects raw content, paths, names, credentials, business terms, and unsupported fields.',
    example: 'node cli/zeus.js technical-evidence acceptance-history --help',
  }),
  ...
  agent: Object.freeze({
    ...
    purpose:
      'Orient CLI agents, generate context-aware prompts, suggest bounded evidence-first workflows, evaluate responses, review contract-improvement candidates against sanitized fixtures and explicit diffs, and record/read local experience events without executing work.',
...
const RECOMMENDED_AI_SEQUENCE = Object.freeze([
  ...
  '`agent feedback review --candidate .zeus/agent-feedback.json --before <path> --after <path> --fixture <path> --json` (verify a sanitized regression fixture and explicit contract diff before promotion)',
