...
module.exports = {
  ...
  CONTRIBUTION_PACKAGE_SCHEMA: portableExport.CONTRIBUTION_PACKAGE_SCHEMA,
  CONTRIBUTION_PACKAGE_KIND: portableExport.CONTRIBUTION_PACKAGE_KIND,
  CONTRIBUTION_PACKAGE_FILES: portableExport.CONTRIBUTION_PACKAGE_FILES,
  createContributionPackage: portableExport.createContributionPackage,
  writeContributionPackage: portableExport.writeContributionPackage,
  openContributionPackage: portableExport.openContributionPackage,
  CONTRIBUTION_GATE_CODES: portableExport.CONTRIBUTION_GATE_CODES,
  validateContributionPackage: portableExport.validateContributionPackage,
  reconcileContribution: portableExport.reconcileContribution,
  stageContributionPackage: portableExport.stageContributionPackage,
  readStagedContribution: portableExport.readStagedContribution,
  transitionStagedContribution: portableExport.transitionStagedContribution,
  planStagingCleanup: portableExport.planStagingCleanup,
  cleanupStagedContributions: portableExport.cleanupStagedContributions,
  EXCHANGE_SCHEMA: portableExport.EXCHANGE_SCHEMA,
  EXCHANGE_KIND: portableExport.EXCHANGE_KIND,
  EXCHANGE_LAYOUT: portableExport.EXCHANGE_LAYOUT,
  EXCHANGE_REASON_CODES: portableExport.EXCHANGE_REASON_CODES,
  createContributionAcceptanceReceipt: portableExport.createContributionAcceptanceReceipt,
  writeContributionExchange: portableExport.writeContributionExchange,
  openContributionExchange: portableExport.openContributionExchange,
  PUBLICATION_SCHEMA: portableExport.PUBLICATION_SCHEMA,
  PUBLICATION_KIND: portableExport.PUBLICATION_KIND,
  PUBLICATION_REASON_CODES: portableExport.PUBLICATION_REASON_CODES,
  ContributionPublicationError: portableExport.ContributionPublicationError,
  publishContributionExchange: portableExport.publishContributionExchange,
  PROVIDER_CONTRIBUTION_SCHEMA: portableExport.PROVIDER_CONTRIBUTION_SCHEMA,
  PROVIDER_CONTRIBUTION_KIND: portableExport.PROVIDER_CONTRIBUTION_KIND,
  PROVIDER_CONTRIBUTION_REASON_CODES: portableExport.PROVIDER_CONTRIBUTION_REASON_CODES,
  ProviderContributionError: portableExport.ProviderContributionError,
  createProviderContribution: portableExport.createProviderContribution,
  createProviderContributionPackage: portableExport.createProviderContributionPackage,
  REQUIRED_GATES: portableExport.REQUIRED_GATES,
  VERIFICATION_RECEIPT_SCHEMA: portableExport.VERIFICATION_RECEIPT_SCHEMA,
  VERIFICATION_RECEIPT_KIND: portableExport.VERIFICATION_RECEIPT_KIND,
  VERIFICATION_RECEIPT_REASON_CODES: portableExport.VERIFICATION_RECEIPT_REASON_CODES,
  VerificationReceiptError: portableExport.VerificationReceiptError,
  createVerificationReceipt: portableExport.createVerificationReceipt,
  validateVerificationReceipt: portableExport.validateVerificationReceipt,
