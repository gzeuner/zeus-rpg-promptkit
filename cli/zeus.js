...
function printHelp() {
  ...
  console.log(
    '  zeus technical-evidence bundle --context <relative-context> --prompt <relative-prompt> --regression <relative-regression> --egress <relative-egress> [--out .local/technical-evidence/bundle.json] [--json]  # local-only fingerprint manifest'
  );
  console.log(
    '  zeus technical-evidence handoff --bundle <relative-bundle> --context <relative-context> --prompt <relative-prompt> --receipt <relative-review-receipt> [--policy required] [--as-of <ISO>] [--fresh-days <n>] [--out .local/technical-evidence/handoff-receipt.json] [--json]  # local-only handoff receipt'
  );
  console.log(
  ...
  console.log(
    '  zeus technical-evidence acceptance-history --current <relative-acceptance-check> [--history <relative-history>] [--as-of <ISO>] [--max-entries <n>] [--out .local/technical-evidence/acceptance-history.json] [--json]  # bounded local history'
  );
  console.log(
...
function parseArgs(argv) {
  const args = { _: [] };
  const multiValueKeys = new Set(['require-column', 'sfl-field', 'tag', 'candidate', 'fixture']);
