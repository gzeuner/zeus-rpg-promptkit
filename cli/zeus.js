...
function printHelp() {
  ...
  console.log(
    '  zeus process <list|describe|query|impact|diff|glossary> --catalog <relative-path> [--glossary <relative-path>] [--id|--term|--question <value>] [scope options] [--json]  # local read-only process and vocabulary retrieval'
  );
  console.log(
